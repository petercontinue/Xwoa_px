 ...
 */
@Getter
public enum WechatCpErrorMsgEnum {
  /**
  ...
  WechatCpErrorMsgEnum(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
  ...
  public static String findMsgByCode(int code) {
    WechatCpErrorMsgEnum[] values = WechatCpErrorMsgEnum.values();
    for (WechatCpErrorMsgEnum value : values) {
      if (value.code == code) {
        return value.msg;
      }
    }
