 ...
 */
@Getter
public enum WechatMpErrorMsgEnum {
  /**
   * 系统繁忙，此时请开发者稍候再试
   */
  ...
  WechatMpErrorMsgEnum(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
  ...
  public static String findMsgByCode(int code) {
    WechatMpErrorMsgEnum[] values = WechatMpErrorMsgEnum.values();
    for (WechatMpErrorMsgEnum value : values) {
      if (value.code == code) {
        return value.msg;
      }
    }
