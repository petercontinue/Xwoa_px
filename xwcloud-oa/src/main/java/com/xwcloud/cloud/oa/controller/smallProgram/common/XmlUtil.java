...
public class XmlUtil {
	...
	public static void main(String[] args){
		String xml="<xml><AppId><![CDATA[wxc063640eb0fd5cce]]></AppId>\n" +
				"<CreateTime>1544098826</CreateTime>\n" +
				"<InfoType><![CDATA[component_verify_ticket]]></InfoType>\n" +
				"<ComponentVerifyTicket><![CDATA[ticket@@@ci_yuZSjGoGGqT_-tE7QjFvLhmAvihB5rqJC4CcXC8UmoK9Z7NiKJm9OG44AxTkYlKd51YCHXNypH6DYDjejUg]]></ComponentVerifyTicket>\n" +
				"</xml>";
		WechatThirdXmlMessage wechatThirdXmlMessage= XmlUtil.toBean(xml,WechatThirdXmlMessage.class);
		System.out.println(XmlUtil.toXmlWithCData(wechatThirdXmlMessage, Lists.newArrayList("CreateTime")));
	}
}
