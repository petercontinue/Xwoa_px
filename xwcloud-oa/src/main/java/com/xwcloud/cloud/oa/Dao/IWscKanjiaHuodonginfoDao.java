 ...
 */
@Repository
public interface IWscKanjiaHuodonginfoDao extends BaseMapper<WscKanjiaHuodonginfo> {
    ...
    @Select("<script>" +
            "SELECT * from  wsc_kanjia_huodonginfo"
            + "</script>")
    List<WscKanjiaHuodonginfo> getAllList();
}