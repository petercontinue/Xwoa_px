...
import com.xwcloud.cloud.zsbm.Dao.IPxbuxistyletableDao;
import com.xwcloud.cloud.zsbm.Service.IPxbuxistyletableService;
...
public class PxbuxistyletableServiceImpl extends ServiceImpl<IPxbuxistyletableDao, Pxbuxistyletable> implements IPxbuxistyletableService {
    ...
    @Override
    public List<searchVO> getbuxistyleList(Long qiyeID) {
